...
This is a sample template for bjhf-simulator - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name bjhf-simulator --tail
```
...
```bash
aws cloudformation delete-stack --stack-name bjhf-simulator
```
